...
<head>
    <meta charset="UTF-8">
    <title>Register — OceanLibrary</title>
...
<body style="background:linear-gradient(160deg,#060d1a,#0a1628 60%,#071220); min-height:100vh; display:flex; align-items:center; justify-content:center; padding: 2rem 0;">
    ...
    <div class="relative z-10 w-full max-w-md mx-4 fade-up">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500 text-sm mt-1">Buat akun dan mulai jelajahi koleksi buku</p>
        </div>
        ...
        <div class="rounded-2xl p-8" style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);backdrop-filter:blur(12px)">
            ...
            <h2 class="font-playfair text-xl text-cyan-400 mb-6">✦ Buat Akun Baru</h2>
            ...
            <form method="POST" action="/register" class="space-y-4">
                ...
                <div>
                    <p class="text-[11px] text-slate-500 uppercase tracking-wider mb-1.5">Nama Lengkap</p>
                    <input type="text" name="name" placeholder="Masukkan nama lengkap..."
                           value="{{ old('name') }}" class="ocean-input">
                </div>

                <div>
                    <p class="text-[11px] text-slate-500 uppercase tracking-wider mb-1.5">Email</p>
                    <input type="email" name="email" placeholder="contoh@email.com"
                           value="{{ old('email') }}" class="ocean-input">
                </div>

                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <p class="text-[11px] text-slate-500 uppercase tracking-wider mb-1.5">Kelas</p>
                        <input type="text" name="kelas" placeholder="XI RPL 1"
                               value="{{ old('kelas') }}" class="ocean-input">
                    </div>

                    
                    <div>
                        <p class="text-[11px] text-slate-500 uppercase tracking-wider mb-1.5">NIS</p>
                        <input type="text" name="nis" placeholder="123456"
                               value="{{ old('nis') }}" class="ocean-input">
                    </div>

                    <div>
                        <p class="text-[11px] text-slate-500 uppercase tracking-wider mb-1.5">No. Telepon</p>
                        <input type="text" name="no_telp" placeholder="081234567890"
                               value="{{ old('no_telp') }}" class="ocean-input" required>
                    </div>
                </div>
            ...
            <p class="text-center text-sm text-slate-500 mt-6">
                Sudah punya akun?
                <a href="/login" class="text-cyan-400 hover:text-cyan-300 transition font-medium">
                    Masuk di sini
                </a>
            </p>
        </div>
